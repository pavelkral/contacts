...
MainWindow::~MainWindow() { closeConnection(); }
...
void MainWindow::on_actionRem_triggered() {
    ...
    if (ixcustm.isValid()) {
        ...
        deletecust = QMessageBox::warning(
            this, tr("Delete contact"),
...
void MainWindow::on_actionAdd_Group_triggered() {
    ...
    table_name =
        QInputDialog::getText(this, tr("New group"), tr("Enter the group name:"),
                                       QLineEdit::Normal, table_name, &ok);
...
void MainWindow::on_actionSearch_triggered() {
    ...
    if (stsearch.isEmpty()) {
        ...
        model->setQuery("SELECT name,phone,mail,adress,notes,idgroup,id FROM "
